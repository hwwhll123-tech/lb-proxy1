// quote.js - 使用 Finnhub 免费行情接口
const FINNHUB_BASE = 'https://finnhub.io/api/v1'

const SESSION_ADJUST = {
  pre:   1.15,
  intra: 1.0,
  post:  0.85,
  night: 0.95
...
module.exports = async (req, res) => {
  ...
  try {
    const tickers = symbols.map(s => s.replace(/\.(US|HK|SH|SZ)$/, ''))
    ...
    console.error('[quote/finnhub]', err.message)
